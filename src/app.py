...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team drills and compete in season games",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["natalie@mergington.edu", "ethan@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Outdoor soccer sessions for skill development and friendly matches",
    ...
    "Music Ensemble": {
        "description": "Rehearse ensemble pieces and perform in school concerts",
    ...
    "Literature Circle": {
        "description": "Read and discuss books, writing, and literary analysis",
